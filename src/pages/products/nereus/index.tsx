...
const product = getProduct('nereus');
...
function NereusProductPage() {
  return (
    <Layout title="Nereus | NereusStream" description={product.summary}>
      <main>
        <section className={styles.hero}>
          <div className={clsx('container', styles.heroGrid)}>
            <div className={styles.heroCopy}>
              <div className={styles.eyebrow}><span className={styles.eyebrowDot} /> {product.statusLabel}</div>
              <h1>Nereus</h1>
              ...
              <div className={styles.heroActions}>
                ...
                <a className={clsx('button button--outline', styles.secondaryButton)} href={product.repositoryUrl}>
                  Nereus on GitHub <span aria-hidden="true">↗</span>
                </a>
              </div>
...
export default NereusProductPage;
